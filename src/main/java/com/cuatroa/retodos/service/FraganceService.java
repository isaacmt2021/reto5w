...
public class FraganceService {
    ...
    public List<Fragance> getByPrice(double price) {
        return repository.getByPrice(price);
    }
    public List<Fragance>getByDescriptionContainingIgnoreCase(String description){
        return repository.getByDescriptionContainingIgnoreCase(description);
    }
